...
function default.grow_tree(pos, is_dead_tree, bad)
	--[[
		NOTE: Tree-placing code is currently duplicated in the engine
		and in games that have saplings; both are deprecated but not
		replaced yet
	...
	local x, y, z = pos.x, pos.y, pos.z
	local height = random(4, 5)
	local c_tree = minetest.get_content_id("default:dead_wood")
	...
	add_trunk_and_leaves(data, a, pos, c_tree, height, 2, 8, is_dead_tree)
